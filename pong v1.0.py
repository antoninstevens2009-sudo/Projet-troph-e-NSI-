...
background.fill((30, 50, 30)) # dark forest green
...
# check si quelqu'un est arriver a 5 points
    ...
    if bar1_score >= WINNING_SCORE:
        # joueur a gagné donc affiché message et fermer le jeu
        msg = font.render("Tu as gagné, la forêt est sauver!", True, (0, 255, 0))
        screen.blit(msg, (150, 200))
        pygame.display.update()
        pygame.time.delay(3000) # attendre 3 seondes pour que joueur lie
        pygame.quit()
        exit()

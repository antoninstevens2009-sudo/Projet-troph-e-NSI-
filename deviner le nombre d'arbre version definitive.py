...
try:
    # Image de fond
    background = pygame.image.load("projet pygame/lutbert Noah/images du projet/pngtree-inferno-a-3d-render-of-a-forest-ablaze-with-flames-and-image_3677061.jpg").convert()
    background = pygame.transform.scale(background, (800, 600))
    
    # Sprite de l'arbre 
    sprite_arbre = pygame.image.load("projet pygame/lutbert Noah/images du projet/sprite arbre qui brule.png").convert_alpha()
